...
public class ExportExcelUtil {
    ...
    public void expoerDataExcel(HttpServletResponse response, ArrayList<String> titleKeyList, Map<String, String> titleMap, List<Map> src_list) throws IOException {

        SimpleDateFormat format = new SimpleDateFormat("yyyyMMddhhmmss");
        Date today = new Date();
        String appId = format.format(today);
        System.out.println(appId);
        String xlsFile_name =  appId+".xlsx";     //输出xls文件名称
        //内存中只创建100个对象
